...
import EditComicCard from '../components/EditComicCard'; 

const AdminComicCard = ({ id, Titlu, Autor, imageUrl, rating, onDelete, onEdit }) => {
        ...
        <Box m={2}>
            <Card sx={{ maxWidth: 345 }}>
                ...
                <CardContent>
                    {isEditing ? (
                        <EditComicCard
                            comicData={{ id, Titlu, Autor, imageUrl, rating }}
