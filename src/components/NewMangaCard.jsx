...
const NewMangaCard = ({ onCreate }) => {
  ...
  const handleCreate = async () => {
    try {
      ...
      console.log("Handling creation of new manga...");
      const imageRef = ref(storage, `manga/${imageFile.name}`);
      ...
      console.log("New manga data:", mangaData);
      await addDoc(collection(firestore, 'manga'), mangaData);
      console.log("Manga added to Firestore");
      onCreate(mangaData); 
      setTitle('');
      setAuthor('');
      setRating(0);
