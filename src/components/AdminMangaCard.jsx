...
import EditMangaCard from '../components/EditMangaCard'; 

const AdminMangaCard = ({ id, Titlu, Autor, imageUrl, rating, onDelete, onEdit }) => {
        ...
        <Box m={2}>
            <Card sx={{ maxWidth: 345 }}>
                ...
                <CardContent>
                    {isEditing ? (
                        <EditMangaCard
                            mangaData={{ id, Titlu, Autor, imageUrl, rating }}
